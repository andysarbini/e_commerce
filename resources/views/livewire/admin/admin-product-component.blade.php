                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        {{-- <img src="{{ ('assets/images/products') }}/{{ $item->model->image }}" alt="{{ $item->model->name }}"> --}}
                                        <td>{{ $product->name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" style = "margin-left:10px" wire:click.prevent="deleteProduct({{$product->product_id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
