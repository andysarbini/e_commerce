            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                @foreach ($sliders as $slide)    
                    <div class="item-slide">
                        {{-- <figure><img src="{{ asset('assets/images/sliders') }}/{{$slide->image}}" alt="" width="1170" height="500"></figure> --}}
                        <figure><img src="{{ asset('assets/images/sliders') }}/{{$slide->image}}" alt="" class="img-slide"></figure>
                        {{-- <figure><img src="{{ asset('assets/images/sliders/home-1-banner-1.jpg') }}" alt="" width="580" height="190"></figure> --}}
